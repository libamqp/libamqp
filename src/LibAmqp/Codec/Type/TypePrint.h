...
extern void amqp_type_dump(amqp_context_t *context, int level, amqp_type_t *type);

extern void amqp_type_print(amqp_context_t *context, amqp_type_t *type);
extern void amqp_type_print_formatted(amqp_context_t *context, amqp_type_t *type);
