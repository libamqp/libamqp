...
{
    class ConnectionSocketFixture : public SuiteConnection::BaseConnectionFixture
    {
    public:
        ConnectionSocketFixture();
        ~ConnectionSocketFixture();

    public:
        amqp_buffer_t *write_buffer;
        amqp_buffer_t *read_buffer;
        amqp_listener_thread_t *echo_server_thread;
