...
namespace test_data
{
    ...
    test_data_def(sasl_init_frame,
        ...
        0x02, 0x01, 0x00, 0x00,
            0x00,
                ...
                0xc0, 45, 3,
                    0xA3, 5, 'P', 'L', 'A', 'I', 'N',
                    0xa0, 15, 0, 'a', 'u', 't', 'h', 'c', 'i', 'd', 0, 's', 'e', 'c', 'r', 'e', 't',
    ...
    // Open(container­id=localhost.unknown-process-name, hostname=development.mysystem.mycompany.stormmq.com, max­frame­size=512, channel­max=0x00FF, idle­time­out=15000, outgoing­locales=[], incoming­locales=[], offered­capabilities=[], desired­capabilities=[], properties={})
    test_data_def(client_open_frame_with_trailing_garbage,
        0x00, 0x00, 0x00, 0x75,
        0x02, 0x00, 0x00, 0x00,
	    0x00,
                0x53, 0x10,
        ...
        0x02, 0x00, 0x00, 0x00, 
            0x00, 
                ...
                0xC0, 0xEF, 0x0E,
                    ...
                    0x43, // handle - uint0
                    0x42, // role
                    0x50, 0x01, // sender settle mode
                    0x40, // receiver settle mode
                0x00,
                    0x53, 0x28,
                    0xC0, 0x7F, 0x0A,
                        0xA1, 0x13,
                        ...
                        0xE0, 0x4E, 0x04,
                            0xA3, 0x12,
                                0x61, 0x6D, 0x71, 0x70, 0x3A, 0x61, 0x63, 0x63,
                                0x65, 0x70, 0x74, 0x65, 0x64, 0x3A, 0x6C, 0x69,
                                0x73, 0x74,
