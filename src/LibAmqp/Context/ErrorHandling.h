...
enum amqp_error_code_t {
    ...
    AMQP_ERROR_UNKNOWN_ARRAY_ELEMENT_FORMAT_CODE,
    ...
    AMQP_ERROR_CORRUPT_FRAME_HEADER,
    AMQP_ERROR_INVALID_FRAME_TYPE,
    AMQP_ERROR_INVALID_FRAME,
    AMQP_ERROR_FRAME_DECODE_FAILED,
    AMQP_ERROR_MULTIPLE_DECODE_FAILED,
    AMQP_ERROR_NO_SASL_MECHANISM,
    AMQP_ERROR_FRAME_FIELD_DECODE_FAILED,
    AMQP_ERROR_FRAME_FIELD_RANGE_ERROR,
    AMQP_ERROR_NO_HOST_NAME,
    AMQP_ERROR_SASL_PLUGINS_REGISTERED,
    AMQP_ERROR_UNSUPPORTED_SASL_MECHANISM,
    AMQP_ERROR_OUT_OF_SEQUENCE_SASL_FRAME,
